...
Für nachvollziehbare Materialprüfungen kann ein signiertes FIE-Preset verwendet werden. Die darin hinterlegten Grenzwerte sind im Gerät nur lesbar einsehbar; bei aktivem Preset kennzeichnet die Benutzeroberfläche den FIE-Modus deutlich. Das schafft Transparenz über die verwendeten Prüfparameter, ohne eine FIE-Zertifizierung oder formale Konformitätsaussage des Testers zu behaupten. Das Messprinzip und die Inhouse-Validierung sind in der [Messvalidierung](./docs/measurement_validation.md) dokumentiert.
...
Eine geringe Zahl dokumentierter Einheiten im Feld ist für diese Evaluierung sinnvoll; eine Ausweitung in kleinen Einzelschritten wäre es nicht. Steigt die Nachfrage über diesen Rahmen hinaus, soll ein geeigneter Hersteller die professionelle beziehungsweise maschinelle Fertigung, die abgeschlossene Konformitätsbewertung und die vollständige Marktfreigabe übernehmen. Voraussetzung ist ein Preis, der den Vereinen und der ehrenamtlichen Entwicklung weiterhin gerecht wird.
